...
import { Coins, Loader2, ArrowRight, User as UserIcon } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#020512] flex flex-col items-center justify-center relative overflow-hidden text-blue-50">
      ...
      >
        ...
        <div className="text-center mt-8 mb-8">
          ...
          <p className="text-blue-300 text-sm font-medium">Create your ID to start extracting high-yield data points.</p>
        </div>
        ...
        >
          <div>
            <label className="block text-xs font-bold text-blue-300 uppercase tracking-wider mb-2">Username</label>
      ...
      <div className="absolute bottom-6 text-blue-500/50 text-xs font-mono uppercase tracking-widest">
         Securely powered by Firebase Engine
      </div>
    </div>
  );
};
